    ...
    <div className={`min-h-screen transition-all duration-500 font-sans ${styles.bg} ${styles.text}`}>
      ...
      <header className="max-w-5xl mx-auto px-6 pt-24 pb-32 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex gap-4">
          ...
          <a href="https://linkedin.com/in/abnerhakinnen" target="_blank" rel="noreferrer" className={`p-3 rounded-full border ${styles.card}`}>
            <Linkedin size={20} />
          </a>
          <a href="https://github.com/abnerhkn" target="_blank" rel="noreferrer" className={`p-3 rounded-full border ${styles.card}`}>
            <Github size={20} />
          </a>
        </div>
      </header>
        ...
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-3 gap-12 text-left">
          <div className="md:col-span-1">
            ...
            <div className={`p-6 rounded-2xl border ${styles.card} flex gap-4 items-center`}>
              ...
              <div>
                <p className="font-bold text-sm">BSc Software Engineering</p>
                <p className="text-[10px] opacity-60">UFC (2018-2024)</p>
              </div>
            </div>
          </div>
          <div className="md:col-span-2 space-y-6">
            {t.aboutText.map((p, i) => <p key={i} className="text-lg opacity-90 leading-relaxed">{p}</p>)}
          </div>
        </div>
      </section>
      ...
      <section className={`py-24 ${isDark ? 'bg-[#0A0A0A]' : 'bg-[#FBFBFD]'}`}>
        <div className="max-w-5xl mx-auto px-6 text-left">
          <h3 className="text-xs font-bold uppercase tracking-widest mb-12 text-blue-500">{t.projectsTitle}</h3>
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((p, i) => (
              <a href={p.link} key={i} target="_blank" rel="noreferrer" className={`p-8 rounded-[2rem] border ${styles.card} group transition-all hover:-translate-y-1`}>
      ...
      <section className="py-24 max-w-5xl mx-auto px-6">
        ...
        <div className="rounded-[2rem] overflow-hidden h-[400px] border border-inherit relative grayscale">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d76274.32130704983!2d-6.319717277800761!3d53.34446006456094!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48670e80ea27ac2f%3A0xa00c7a9973171a0!2sDublin%2C%20Ireland!5e0!3m2!1sen!2sbr!4v1710000000000!5m2!1sen!2sbr" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            allowFullScreen="" 
      ...
      <footer className="py-24 text-center">
        ...
        <a href="mailto:dev.abnerlima@gmail.com" className={`inline-flex items-center gap-3 px-10 py-4 rounded-full font-bold transition-all ${isDark ? 'bg-white text-black' : 'bg-black text-white'}`}>
